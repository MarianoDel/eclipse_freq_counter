...
//	Send_SPI_Multiple(0xA0);		//0x00	C1=0 C2=0, R counter / 1000

	Send_SPI_Multiple(0x00);		//0x00
	Send_SPI_Multiple(0x9C);		//0x00
	Send_SPI_Multiple(0x40);		//0x00	C1=0 C2=0, R counter / 10000
...
//	Send_SPI_Multiple(0x01);		//0x01		00100000; C1=1 C2=0, N counter / 1250
	...
	Send_SPI_Multiple(0x00);		//0x00
	Send_SPI_Multiple(0x9C);		//0x00
	Send_SPI_Multiple(0x41);		//0x01		00100000; C1=1 C2=0, N counter / 312.5
